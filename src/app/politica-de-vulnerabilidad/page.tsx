...
export const metadata: Metadata = {
  title: 'Política de Vulnerabilidades | GoSoft Solutions',
  description: 'Política de divulgación responsable de vulnerabilidades de GoSoft Solutions.',
        ...
        <div className="bg-transparent">
          ...
          <div className="prose prose-lg max-w-none text-gray-800">
            <p className="text-lg mb-6">
              En <strong>GoSoft Solutions</strong>, tomamos en serio la seguridad de nuestros 
              sistemas y aplicaciones. Esta política establece el procedimiento para reportar 
              vulnerabilidades de manera responsable.
            </p>
            ...
            <p className="mb-6">
              Si descubres una vulnerabilidad en nuestros sistemas, te pedimos que sigas 
              nuestro proceso de divulgación responsable para proteger a nuestros usuarios.
            </p>
            ...
            <ul className="mb-6 space-y-2">
              <li>Envía un reporte detallado a security@gosoftsolutions.com</li>
              <li>Incluye información sobre la vulnerabilidad encontrada</li>
              <li>Proporciona pasos para reproducir el problema</li>
              <li>Evita acceder a datos personales de otros usuarios</li>
              <li>No publiques la vulnerabilidad hasta que sea corregida</li>
            </ul>
            ...
            <ul className="mb-6 space-y-2">
              ...
              <li>Ingeniería social de empleados</li>
              <li>Acceso no autorizado a datos</li>
              <li>Modificación o destrucción de datos</li>
            </ul>
            ...
            <p className="mb-4">
              Para reportes de vulnerabilidades:
            </p>
            <p>
