...
export const metadata: Metadata = {
  title: 'Privacy Policy | GoSoft Solutions',
  description: 'Privacy policy and confidential information handling at GoSoft Solutions.',
  keywords: 'privacy, confidentiality, data protection, GoSoft Solutions',
};
...
export default function PrivacyPolicyPageEN() {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <PolicyNavigation currentPage="privacy-policy" />
        ...
        <div className="bg-transparent">
          ...
          <div className="prose prose-lg max-w-none text-gray-800">
            <p className="text-lg text-gray-700 mb-6">
              At <strong>GoSoft Solutions</strong>, we are committed to protecting the confidentiality 
              of all information entrusted to us, establishing the highest security and privacy standards.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Confidential Information</h3>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
              <li>Sensitive business data</li>
              <li>Technical and commercial information</li>
              <li>Project documentation</li>
              <li>Internal communications</li>
            </ul>
            
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Protection Measures</h3>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
            ...
            <p className="text-gray-700 mb-6">
              We guarantee absolute protection of confidential information through advanced security 
              protocols, controlled access, and staff trained in confidentiality best practices.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              For inquiries related to confidentiality and security:
            </p>
