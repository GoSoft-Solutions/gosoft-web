...
export const metadata: Metadata = {
  title: 'Terms and Conditions | GoSoft Solutions',
  description: 'Terms and conditions of use for GoSoft Solutions services.',
  keywords: 'terms of service, conditions of use, GoSoft Solutions',
};
...
export default function TermsAndConditionsPageEN() {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <PolicyNavigation currentPage="terms-and-conditions" />
        ...
        <div className="bg-transparent">
          ...
          <div className="prose prose-lg max-w-none text-gray-800">
            <p className="text-lg text-gray-700 mb-6">
              ...
              <strong> GoSoft Solutions</strong>. By using our services, you agree to be bound by these terms.
            </p>
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                GoSoft Solutions offers enterprise software development services, 
                technology consulting, and customized digital solutions.
              </p>
            </div>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
              ...
              <li>Comply with agreed deadlines</li>
            ...
            <p className="text-gray-700 mb-4">
              For inquiries about our terms of service:
            </p>
